...
<h1 style="color: beige;font-family: serif;font-size: 49px;background-color: cadetblue;border-radius: 100px;">Job Tracker</h1>
<p style="justify-self: center;font-style: italic; font-size: larger;background-color: beige;border-radius: 100px;font-family: cursive;">💡 A place for people to find mini jobs 💡</p>
